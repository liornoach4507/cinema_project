...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($username_err) && empty($email_err) && empty($password_err)) {
        ...
        if ($stmt = mysqli_prepare($link, $sql)) {
            ...
            mysqli_stmt_bind_param($stmt, "sssi", $param_username, $param_email, $param_password, $param_balance);

            # Set parameters
            $param_username = $username;
            $param_email = $email;
            $param_password = password_hash($password, PASSWORD_DEFAULT);
            $param_balance = 1000; // Default balance for new users
...
<head>
    ...
    <link rel="shortcut icon" href="./img/mov.jpg" type="image/x-icon">
    ...
    <div class="container">
        <div class="row min-vh-100 justify-content-center align-items-center">
            <div class="col-lg-5">
                ...
                <div class="form-wrap border rounded p-4" style="background-color: rgba(255, 255, 255, 0.8);">
                    <h1>Sign up</h1>
